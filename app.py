...
from alocacao_suplentes_simulacao import get_google_sheet_data, upload_file_to_drive, normalizar_texto, classificar_cargo_padrao, contar_detalhado_efetivos_e_desvios, rodar_distribuicao, main
